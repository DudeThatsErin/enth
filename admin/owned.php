...
if ($action == 'template') {
    ...
    $id = RobotessNet\StringUtils::instance()->cleanNormalize($_REQUEST['id']);
...
if ($show_default) {
    ...
    <table>
        ...
        foreach ($ids as $id) {
            ...
            ?>
            <td class="center">
                <a href="owned.php?action=edit&id=<?= $id ?>"><img src="edit.gif"
                                                                   width="42" height="19" border="0" alt=" edit"
                                                                   title=" edit"/></a>
                <a href="members.php?id=<?= $id ?>"><img src="manage.gif"
                                                         width="42" height="19" border="0" alt=" manage"
                                                         title=" manage"/></a>
                <a href="owned.php?action=delete&id=<?= $id ?>"
